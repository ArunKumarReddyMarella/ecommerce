...
public class UserControllerTest {
    ...
    void testGetUsersDesc() {
        ...
        Sort sort = Sort.by(sortDirection.equalsIgnoreCase("asc") ? Sort.Direction.ASC : Sort.Direction.DESC, "username");
        Pageable pageable = PageRequest.of(page, size, sort);
        Page<User> expectedUsers = getUsers(pageable);
        when(userService.getUsers(pageable)).thenReturn(expectedUsers);
        ResponseEntity<Page<User>> response = userController.getUsers(page, size, sortDirection);
